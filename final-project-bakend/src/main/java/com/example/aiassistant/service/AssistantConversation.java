...
//                    System.out.println("Response from OpenAI: " + response.toString());
    ...
    public String createUserMessage(String threadId, String message){
        try {
            // URL for the OpenAI Chat Completion endpoint
...
//                    System.out.println("Response from OpenAI: " + response.toString());
                    String assistantMessage = this.getMostRecentMessage(this.getMessages(threadId)).toString();
...
//
    ...
    public void defaultRAGConversation(){
        ...
        do {
            ...
            Object assistantReply = this.assistantReply(this.threadId, this.assistantId);
...
//                    System.out.println("Temperature has been changed to " + temp + "\n" + response);
    ...
    public static void main(String[] args){
        ...
        System.out.println("File has been uploaded to assistant: " + conversation.uploadFileToAssistant("/Users/joshv/repos/final-project-CS514/AIAssistantBackEnd/final-project-bakend/src/main/java/com/example/aiassistant/cs514_exception_handling_worksheet.pdf", false));
        System.out.println("File has been uploaded to assistant: " + conversation.uploadFileToAssistant("/Users/joshv/repos/final-project-CS514/AIAssistantBackEnd/final-project-bakend/src/main/java/com/example/aiassistant/Javascript and React Worksheet.pdf", false));
//
...
//        System.out.println("Assistant object after temperature add:\n" + conversation.getAssistant(conversation.assistantId));
        ...
        conversation.assistantReply(conversation.getThreadId(), conversation.getAssistantId());
